// id, name, absolute magnitude, estimated diameter (km), potentially hazardous asteroid,
// close approach date (full), relative velocity, miss distance (km), sentry object
